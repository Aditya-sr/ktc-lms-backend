...
use App\Models\Admin\Fee\FeeTemplateItem;

class FeeTemplateItemTable extends DataTableComponent
{
    protected $model = FeeTemplateItem::class;
    ...
    public function columns(): array
    {
        return [
            Column::make("Id", "id")
                ->searchable()->hideIf(1),
            Column::make("Fee template id", "fee_template_id")
                ->searchable(),
            Column::make("Organization id", "organization_id")
                ->searchable()->hideIf(1),
            Column::make("Fee head id", "fee_head_id")
                ->searchable(),
            Column::make("Amount", "amount")
                ->searchable(),
            Column::make("Is optional", "is_optional")
                ->searchable(),
            Column::make("Is discount", "is_discount")
                ->searchable(),
