...
class FeeInstallmentTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            Column::make("Id", "id")
                ->searchable()->hideIf(1),
            Column::make("Fee assignment id", "fee_assignment_id")
                ->searchable(),
            Column::make("Organization id", "organization_id")
                ->searchable()->hideIf(1),
            Column::make("Installment number", "installment_number")
                ->searchable(),
            ...
            Column::make("Due date", "due_date")
                ->searchable(),
            Column::make("Paid date", "paid_date")
                ->searchable(),
            Column::make("Status", "status")
                ->searchable(),
            Column::make("Payment method", "payment_method")
                ->searchable(),
            Column::make("Transaction reference", "transaction_reference")
                ->searchable()->hideIf(1),
