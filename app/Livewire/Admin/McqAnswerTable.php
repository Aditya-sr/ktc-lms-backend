...
class McqAnswerTable extends DataTableComponent
{
    protected $model = McqUserAnswer::class;
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("User", "user_id")
                ->searchable(),
            Column::make("Mcq question", "mcq_question_id")
                ->searchable(),
            Column::make("Mcq option", "mcq_option_id")
                ->searchable(),
            Column::make("Time taken", "time_taken")
                ->searchable(),
            Column::make("Is correct", "is_correct")
                ->searchable(),
