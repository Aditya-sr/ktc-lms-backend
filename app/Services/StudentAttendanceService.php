...
class StudentAttendanceService
{
    ...
    public function getStudentsForAttendance($teacherDetailId, $organizationId, $date = null)
    {
        ...
        return DB::transaction(function () use ($teacherDetailId, $organizationId, $date) {
            ...
            // Get all students from assigned classes with today's attendance status
            return StudentDetail::with(['user', 'standard', 'section'])
                ->where('organization_id', $organizationId)
                ->whereIn('standard_id', $teacherAssignments->pluck('standard_id'))
    ...
    /**
     * Bulk submit attendance (optimized for 100+ records)
     */
